...
public class ScalrResizeTest extends AbstractScalrTest {
    ...
    public void testResizeWHSpeedExactOps() {
        ...
        //Scalr.resize(src, Method.SPEED, Mode.FIT_EXACT, 640, 640);
        //);
        BufferedImage bufferedImage = Scalr.resize(src, Method.AUTOMATIC, Mode.FIT_EXACT, 640, 640);
        File outFile = new File("src/test/resources/test5.png");
        outFile.delete();
        try {
     ...
     * @param outPath
     *            输出路径
     * @param  direction 0表标y,1表示x
     */
    public static void yPic(java.util.List<String> piclist, String outPath, int direction) {// 纵向处理图片
        ...
        try {
            ...
            java.util.List<int[]> imgRGB = new ArrayList<int[]>(); // 保存所有的图片的RGB
            ...
            for (int i = 0; i < picNum; i++) {
                ...
                if ( direction == 0 ) {
                    ...
                    imageResult.setRGB(_width, _height, __width, __height, imgRGB.get(i), 0, __width); // 写入流中
                }
            }
    ...
    @Test
    public void composePic() throws IOException {
        java.util.List<String> list = new ArrayList<String>();
        java.util.List<String> list2 = new ArrayList<String>();
        java.util.List<String> list3 = new ArrayList<String>();
        list.add("C:\\\\code\\\\imgscalr-master\\\\imgscalr-master\\\\src\\\\test\\\\resources\\\\test1.png");
        list.add("C:\\\\code\\\\imgscalr-master\\\\imgscalr-master\\\\src\\\\test\\\\resources\\\\test2.png");
        list2.add("C:\\\\code\\\\imgscalr-master\\\\imgscalr-master\\\\src\\\\test\\\\resources\\\\test3.png");
        list2.add("C:\\\\code\\\\imgscalr-master\\\\imgscalr-master\\\\src\\\\test\\\\resources\\\\test4.png");
        //yPic(list, "C:\\code\\imgscalr-master\\imgscalr-master\\src\\test\\resources\\out.png",0);
        yPic(list2, "C:\\code\\imgscalr-master\\imgscalr-master\\src\\test\\resources\\out2.png",1);

        list3.add("C:\\\\code\\\\imgscalr-master\\\\imgscalr-master\\\\src\\\\test\\\\resources\\\\out2.png");
        list3.add("C:\\\\code\\\\imgscalr-master\\\\imgscalr-master\\\\src\\\\test\\\\resources\\\\out2.png");
        yPic(list3, "C:\\code\\imgscalr-master\\imgscalr-master\\src\\test\\resources\\out3.png",0);
        /*composePic("C:\\code\\imgscalr-master\\imgscalr-master\\src\\test\\resources\\test1.png",
				"C:\\code\\imgscalr-master\\imgscalr-master\\src\\test\\resources\\test2.png",
				"C:\\code\\imgscalr-master\\imgscalr-master\\src\\test\\resources\\out.png",800,800);*/
    }
